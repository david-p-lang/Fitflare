...
extension UIViewController {
    ...
    func removeSet(name: String) {
        ...
        var resultsController:NSFetchedResultsController<PlayerStats>!
        
        //create a request of type training set
        let request:NSFetchRequest<PlayerStats> = NSFetchRequest(entityName: "PlayerStats")
        ...
        resultsController = NSFetchedResultsController(fetchRequest: request, managedObjectContext: DataController.shared.mainContext, sectionNameKeyPath: nil, cacheName: nil)
        ...
        guard let trainingSet = resultsController.fetchedObjects?.first else { return }
